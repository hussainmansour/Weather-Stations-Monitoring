...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4740807554786831975L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Weather\",\"namespace\":\"weather.station\",\"fields\":[{\"name\":\"humidity\",\"type\":\"int\"},{\"name\":\"temperature\",\"type\":\"int\"},{\"name\":\"wind_speed\",\"type\":\"int\"}]}");
   ...
   */
  public static weather.station.Weather.Builder newBuilder() {
    return new weather.station.Weather.Builder();
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static weather.station.Weather.Builder newBuilder(weather.station.Weather.Builder other) {
    if (other == null) {
      return new weather.station.Weather.Builder();
    } else {
      return new weather.station.Weather.Builder(other);
    }
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static weather.station.Weather.Builder newBuilder(weather.station.Weather other) {
    if (other == null) {
      return new weather.station.Weather.Builder();
    } else {
      return new weather.station.Weather.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(weather.station.Weather.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(weather.station.Weather other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.humidity)) {
        this.humidity = data().deepCopy(fields()[0].schema(), other.humidity);
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder setHumidity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder clearHumidity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder setTemperature(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder setWindSpeed(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public weather.station.Weather.Builder clearWindSpeed() {
