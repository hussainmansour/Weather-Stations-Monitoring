...
public class CsvWriter {
    public static void writeToFile(HttpURLConnection conn) throws Exception {
        ...
        writeKeyValueToCsv(keys, values);
    }

    private static void writeKeyValueToCsv(ArrayList<Long> key, ArrayList<String> value) {
